...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        if (subcommand === "set-mod-logs") {
            ...
            data.modLogs[0].value = warn;
            data.modLogs[1].value = timeout;
            data.modLogs[2].value = kick;
            data.modLogs[3].value = ban;
            await data.save();
            await client.configs.set(guild.id, data);
            let string = "";
            if (warn) string += "✅ warn\n";
        ...
        if (subcommand === "set-member-logs") {
            ...
            data.memberLogs[0].value = role;
            data.memberLogs[1].value = name;
            data.memberLogs[2].value = avatar;
            await data.save();
            await client.configs.set(guild.id, data);
            let string = "";
        ...
        if (subcommand === "set-voice-logs") {
            ...
            data.voiceLogs[0].value = join;
            data.voiceLogs[1].value = move;
            data.voiceLogs[2].value = leave;
            await data.save();
            await client.configs.set(guild.id, data);
            let string = "";
        ...
        if (subcommand === "set-message-logs") {
            ...
            data.messageLogs[0].value = deleted;
            data.messageLogs[1].value = edited;
            data.messageLogs[2].value = purged;
            await data.save();
            await client.configs.set(guild.id, data);
            let string = "";
